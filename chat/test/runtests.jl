...
# !!! Main.UserApp is configured as an alias for Main.Chat and you might encounter it in some tests
using Main.Chat, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Chat tests" begin
  @includetests ARGS
end
